...
# (playtomic_team_no, p1, r1, p2, r2) — from the Manager entrant list, 1 Sep 2026.
# 67 teams / 134 players against the raised 100-team cap. Two different players share
...
ROSTER = [
    ...
    (17, "Mark Banim", 2.60, "Anton Burihhin", 2.17),
    (18, "Kieran Fraser", 2.80, "Ana J", 1.88),
    (19, "Shaun Humby", 2.30, "Thomas McKeon", 2.32),
    (20, "Tom Maguire", 2.12, "Brian O'Sullivan", 2.44),
    (21, "Lee Fitzpatrick", 2.33, "Mo Dunne", 2.20),
    (22, "Kayleigh Sullivan", 2.18, "Leanne S", 2.29),
    (23, "Charles Lee", 3.06, "Cami Ammirevole", 1.37),
    (24, "Karol Stankiewicz", 1.78, "Sath", 2.48),
    (25, "Gabriel Uribe", 2.23, "Aron Souto", 2.01),
    (26, "Callum Smale", 2.64, "Ryan Tolan", 1.57),
    (27, "Cillian Williams", 2.53, "Ava Williams", 1.66),
    (28, "Keefe Lang", 2.68, "Chris Lang", 1.51),
    (29, "John D", 2.11, "Sam Harte", 2.02),
    (30, "Toby Wuyts", 2.39, "Jack Dunn", 1.73),
    (31, "Oussama Kenouche", 2.36, "Jack Colaluca", 1.69),
    (32, "Fionn Lang", 2.11, "Anthea Lang", 1.88),
    (33, "Peter Dunne", 2.41, "Lillian Carthy", 1.54),
    (34, "Lorraine Gallagher", 1.59, "Tina Meehan", 2.36),
    (35, "Kieran Fitzpatrick", 2.53, "Stephen Fitzpatrick", 1.27),
    (36, "David O Neill", 1.97, "John O Neill", 1.68),
    (37, "Mark Tindale", 1.60, "Mark Williams", 1.98),
    (38, "Tom Foley", 1.50, "Fernando Souza", 1.79),
    (39, "Gary Stephenson", 1.20, "Wayne Neary", 2.04),
    (40, "Niamh Cassidy", 0.95, "Linda Dempsey", 2.00),
    (41, "Claire Austen", 2.31, "CJ Adams", 0.65),
    (42, "Fran Ford", 1.82, "D M", 1.14),
    (43, "Damien Dunne", 1.41, "Joanne Dunne", 1.56),
    (44, "Boodhan Rampersaud", 1.54, "Anto Doran", 1.22),
    (45, "Nicole Mello Teixeira de Almeida", 1.18, "Grainne Ring", 1.55),
    (46, "Rick Deady", 1.22, "Shirley Deady", 1.40),
    (47, "Michele McCormack", 0.98, "Sonja", 1.62),
    (48, "Zydre", 1.29, "Indre Simkute", 1.27),
    (49, "Eva Rybak", 1.27, "Kris Rybak", 1.28),
    (50, "Conor Dodd", 1.00, "Dillon Mordaunt", 1.49),
    (51, "Eoin Tiernan", 1.22, "Eamonn Madden", 1.14),
    (52, "John Lester", 1.28, "Kyle Dempsey", 1.05),
    (53, "Katie Marie", 1.10, "Aoife Williams", 1.20),
    (54, "Ian Donoghue", 1.12, "Sean Cleary", 1.00),
    (55, "Gary Brady", 0.71, "Ciaran O'Donoghue", 1.29),
    (56, "Orla Murphy Fleming", 1.30, "Doireann", 0.51),
    ...
    (57, "Barry MacCourt", 0.88, "Michael Gombart", UNRATED_DEFAULT),
    (58, "Sandra Dunne", 0.66, "Kerrie Beacom", 1.01),
    (59, "Jack Evans", 0.83, "Gavin Fogarty", 0.80),
    (60, "Ciara Kavanagh (2)", 1.00, "Ciaran Conlon", 0.56),
    (61, "Elaine Kirwan", 1.00, "Christina Reilly", 0.50),
    (62, "Aoife Shine", 0.50, "Niall Ryan", 0.87),
    (63, "Adam Macaulay", 0.66, "Giedre Guobyte", 0.50),
    (64, "Bairbre Heron", 0.50, "James Heron", 0.59),
    (65, "John Kavanagh", 0.50, "Kellie Kavanagh", 0.50),
    (66, "Rhys Mansueto", 0.50, "Jeff O'Brien", 0.50),
