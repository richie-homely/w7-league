...
export const KNOCKOUT_RESULTS: {
  ...
  {
    // Lower-tier QF: G1 (Wojnar & Maguire) v G1 (Humby & McKeon) — both R1 winners.
    // 12 Sep 2026, from Shaun Humby's Playtomic result card — Wojnar & Maguire won
    // in two. Alfie Doyle subbed for Thomas McKeon again.
    teams: [
      "62da68dd-80f6-4d26-ae14-a449466bf150", // Wesley Wojnar & Tom Maguire
      "3f2812d0-ca30-4f49-ad0c-c5c63489cfe7", // Shaun Humby & Thomas McKeon
    ],
