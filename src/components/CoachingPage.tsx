    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: F.body }}>
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 20px 36px" }}>
          ...
          >
            Coaching at <span style={{ color: C.accent }}>W7</span>
          </h1>
          <p
            style={{
              fontSize: 14.5,
          ...
          >
            Whatever your level, a lesson is the fastest way to move up a box. Private 1-to-1s,
            small groups, complete-beginner intros and junior sessions — pick your format and
            book in.
          </p>
        </div>
      </div>
