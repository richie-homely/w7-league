...
const STEPS: { h: string; body: (string | string[])[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Play 2 full sets, then a championship tie-break if it is one set each. At deuce, play advantage twice; at the third deuce the next point is a golden point and wins the game. Substitutes are allowed if their Playtomic rating is within 0.75 of the player they replace — tap Log a sub on the fixture and enter who sat out, the sub's name and their Playtomic rating; it shows beside the fixture and W7 reviews anything outside the 0.75.",
    ],
  },
  {
